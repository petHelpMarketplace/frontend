...
const ServiceTypeSelector = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-x-[10px] gap-y-3.5 mb-[33px] xl:mb-0 xl:grid-cols-4 xl:gap-7">
      {services.map(service => (
        <button
          key={service.label}
          className="flex flex-col items-center justify-center py-4.5 rounded-[14px] text-[15px] leading-[120%] xl:rounded-2xl border-tenn border-[2px] shadow-filter xl:shadow-none hover:bg-tenn hover:text-alabaster hover:border-none hover:shadow-shark active:shadow-inset-shark group xl:gap-2 xl:py-3 xl:px-13 xl:flex-row"
        >
          <svg
