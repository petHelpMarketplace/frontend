...
const HeroSection = () => {
  return (
    <section className="relative w-full max-w-[375px] xl:max-w-[1280px] mx-auto h-[858px] xl:max-h-165 rounded-b-[40px] z-10 -mt-[56px] xl:-mt-20 px-[15px] pt-0 xl:py-12 xl:px-30 mb-0 xl:mb-40 bg-hero-gradient">
