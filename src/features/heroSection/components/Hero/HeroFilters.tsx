...
const HeroFilters = () => {
  ...
  return (
    <div className="relative bg-alabaster shadow-box rounded-[25px] max-h-[622px] xl:rounded-2xl pt-[27px] pb-[77px] px-4.5 xl:py-4 xl:px-8 w-full mx-auto flex flex-col  xl:gap-3.5 xl:mb-0 xl:-mt-212 z-10 left-1/2 -translate-x-1/2">
