...
const HeroFilters = () => {
  ...
  return (
    <div
      className={`absolute bg-alabaster shadow-box rounded-[25px] xl:rounded-2xl py-[27px] px-4.5 xl:py-5 xl:px-8 xl:w-[1040px] mx-auto xl:max-h-[298px] flex flex-col xl:gap-3.5 xl:mb-0 xl:-mt-212 z-10 left-1/2 -translate-x-1/2 ${heightClass}`}
    >
