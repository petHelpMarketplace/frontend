...
export const privacyPolicyData: PrivacyPolicyData[] = [
  ...
  },
  {
    ...
    description: [
      {
        text: 'Компанія залишає за собою право змінити умови даної Політики в будь-який момент. В такому випадку, оновлена редакція буде розміщена на сторінці за адресою: https://petshelp.ua/privacy-policy. У випадку, якщо Користувач не погоджується із змінами, він зобов’язується негайно припинити будь-яку взаємодію з Порталом.',
      },
      {
        text: 'Компанія не несе відповідальності за шкоду або збитки, яких зазнав Користувач або треті особи в результаті помилкового розуміння або нерозуміння умов цієї Політики.',
      },
      {
