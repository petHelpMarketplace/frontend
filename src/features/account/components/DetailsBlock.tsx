export default function DetailsBlock() {
  return (
    <div className="flex flex-col flex-grow pb-9">
      <label
        htmlFor="about"
      ...
      <textarea
        ...
        name="about"
        rows={6}
        className="border-2 border-fire rounded-2xl px-7 py-7 text-shark placeholder:text-storm-dust resize-none focus:outline-fire"
