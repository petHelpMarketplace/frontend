...
const SpecialistInfo = () => {
  ...
  return (
    <div className="xl:w-[304px] xl:px-4 pt-4 pb-[15px] box-border rounded-2xl shadow-smoke">
      <div className="flex items-center justify-center w-[272px] h-[364px] mb-5 rounded-2xl overflow-hidden">
        <img
