import { footerSections } from '@/features/Footer/footerData';
import { Link } from 'react-router-dom';
import Accordion from '@/features/Footer/Accordion';
  ...
  return (
    <footer
      ...
      className="w-full mx-auto text-alabaster bg-gradient-to-t from-red-beech to-fiery-tenn rounded-t-[60px]
        px-[26px] pt-[44px] pb-[27px] max-w-[375px]
    ...
    >
      ...
      {/* Mobile: Accordion */}
      <div className="flex flex-col text-lg gap-7 mb-[61px] xl:hidden">
